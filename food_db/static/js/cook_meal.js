...
function celebrate() {
    party.confetti(upvoteButton)
    setTimeout(function () {party.sparkles(upvoteButton)}, 500)
    setTimeout(function () {party.sparkles(upvoteButton)}, 1000)
    setTimeout(function () {party.sparkles(upvoteButton)}, 1500)
    setTimeout(function () {party.sparkles(upvoteButton)}, 2000)
    setTimeout(function () {party.sparkles(upvoteButton)}, 2500)
    setTimeout(function () {party.confetti(upvoteButton)}, 3200)
}
