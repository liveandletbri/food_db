...
class GroceryList:
    ...
    def __init__(self, ingred_data_list: list[RecipeIngredientData], multiplier):
        self.food_quantity_dict = defaultdict(lambda: defaultdict(lambda: defaultdict(list)))  # food_category -> food -> unit of measurement -> list of quantities. This is the raw quantities to sum.
    ...
    def _sum_food_quantities(self, ingred_data_list: list[RecipeIngredientData]):
        ...
        for food_category, food_dict in dict(self.food_quantity_dict).items():
